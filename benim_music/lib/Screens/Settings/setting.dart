...
import 'package:benim_music/CustomWidgets/copy_clipboard.dart';
import 'package:benim_music/CustomWidgets/gradient_containers.dart';
import 'package:benim_music/CustomWidgets/popup.dart';
...
import 'package:benim_music/Helpers/picker.dart';
import 'package:benim_music/Helpers/supabase.dart';
import 'package:benim_music/Screens/Home/saavn.dart' as home_screen;
import 'package:benim_music/Screens/Settings/player_gradient.dart';
import 'package:benim_music/Services/ext_storage_provider.dart';
import 'package:benim_music/main.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/Benimmusic/Backups',
  ) as String;
  ...
  String region =
      Hive.box('settings').get('region', defaultValue: 'Turkish') as String;
  bool useProxy =
  ...
  List preferredLanguage = Hive.box('settings')
      .get('preferredLanguage', defaultValue: ['Turkish'])?.toList() as List;
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          //   GÜZEL EKRAN RESİMLERİ AL ,  SON KONTROLLERİ YAP VE UYGULAMAYI İMZALAYIP APP BUNDLE AL VE PLAYE YÜKLE
                            ...
                            onPressed: () async {
                              autoBackPath =
                                  await ExtStorageProvider.getExtStorage(
                                      ...
                                      '/storage/emulated/0/Benimmusic/Backups';
                              Hive.box('settings')
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            launchUrl(
                              Uri.parse(
                                'https://www.buymeacoffee.com/omertaske',
                              ),
                        ...
                        //   onTap: () {
                        //     const String upiUrl =
                        //         'upi://pay?pa=ankit.sangwan.5688@oksbi&pn=Benimmusic';
                        //     launchUrl(
                        //       Uri.parse(upiUrl),
                        //       mode: LaunchMode.externalApplication,
                        //     );
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                launchUrl(
                                                  Uri.parse(
                                                    'mailto:omertaskesenn@gmail.com?subject=Mymusic',
                                                  ),
                                                  mode: LaunchMode
                                                      .externalApplication,
                                                );
                        ...
                        //                         launchUrl(
                        //                           Uri.parse(
                        //                             'https://t.me/Benimmusic_official',
                        //                           ),
                        //                           mode: LaunchMode
                        //                               .externalApplication,
                        //                         );
